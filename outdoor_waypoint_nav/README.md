...
```
cd catkin_ws/src
git clone https://github.com/ArghyaChatterjee/gps-waypoint-based-autonomous-navigation-in-ros.git outdoor_waypoint_nav
cd ..
catkin_make --only-pkg-with-deps outdoor_waypoint_nav
```
